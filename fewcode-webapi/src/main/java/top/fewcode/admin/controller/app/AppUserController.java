...
import top.fewcode.admin.appSystem.model.req.user.AppUserImportReq;
import top.fewcode.admin.appSystem.model.req.user.AppUserPasswordResetReq;
import top.fewcode.admin.appSystem.model.req.user.AppUserReq;
 ...
 */
@Tag(name = "小程序用户管理 API")
@Validated
@RestController
@RequiredArgsConstructor
@CrudRequestMapping(value = "/app/user", api = {Api.PAGE, Api.LIST, Api.DETAIL, Api.ADD, Api.UPDATE, Api.DELETE,
        Api.EXPORT})
public class AppUserController extends BaseController<AppUserService, AppUserResp, AppUserDetailResp, AppUserQuery, AppUserReq> {

    private final AppUserService userService;

    @Override
    public BaseIdResp<Long> add(@Validated(CrudValidationGroup.Add.class) @RequestBody AppUserReq req) {
    ...
    public AppUserImportParseResp parseImport(@NotNull(message = "文件不能为空") MultipartFile file) {
    ...
    public AppUserImportResp importUser(@Validated @RequestBody AppUserImportReq req) {
    ...
    public void resetPassword(@Validated @RequestBody AppUserPasswordResetReq req, @PathVariable Long id) {
