 ...
 */
package top.fewcode.admin.controller.knowledge;
...
@RestController
@CrudRequestMapping(value = "/knowledge/knowledgeManage", api = {Api.PAGE, Api.DETAIL, Api.ADD, Api.UPDATE, Api.DELETE,
    Api.EXPORT})
