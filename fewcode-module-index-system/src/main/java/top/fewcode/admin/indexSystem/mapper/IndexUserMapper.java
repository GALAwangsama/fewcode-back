 ...
 */
package top.fewcode.admin.indexSystem.mapper;
 ...
 */
public interface IndexUserMapper extends DataPermissionMapper<IndexUserDO> {
    ...
    IPage<IndexUserDetailResp> selectIndexUserPage(@Param("page") IPage<IndexUserDO> page,
                                              @Param(Constants.WRAPPER) QueryWrapper<IndexUserDO> queryWrapper);
     ...
     */
    @DataPermission(tableAlias = "t1")
    List<IndexUserDetailResp> selectIndexUserList(@Param(Constants.WRAPPER) QueryWrapper<IndexUserDO> queryWrapper);
    ...
    IndexUserDO selectByUsername(@Param("username") String username);
    ...
    IndexUserDO selectByPhone(@FieldEncrypt @Param("phone") String phone);
    ...
    IndexUserDO selectByEmail(@FieldEncrypt @Param("email") String email);
