 ...
 */
package top.fewcode.admin.indexSystem.model.entity;
 ...
 */
@Data
@DictField(labelKey = "indexnickname", extraKeys = {"username"})
@TableName("sys_index_user")
public class IndexUserDO extends BaseDO {
