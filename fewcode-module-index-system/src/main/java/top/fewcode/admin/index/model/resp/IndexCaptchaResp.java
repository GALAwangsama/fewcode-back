...
public class IndexCaptchaResp implements Serializable {
     ...
     * @return 验证码信息
     */
    public static IndexCaptchaResp of(String uuid, String img, Long expireTime) {
        return IndexCaptchaResp.builder().uuid(uuid).img(img).expireTime(expireTime).isEnabled(true).build();
    }
}
